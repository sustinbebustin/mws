...
> **Note:** [React Compiler](https://react.dev/learn/react-compiler) can automatically memoize expensive calculations for you, eliminating the need for manual `useMemo` in many cases.
